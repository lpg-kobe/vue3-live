<template>
  <div>
    <div class="question_block">
      <chatScroll
        ref="chatscroll"
        :wrapClass="'question_block'"
        @maxBottom="handleReachTop"
      >
        <ul class="question height_ul2" v-show="dataList.length > 0">
          <li v-for="(item, index) of dataList" :key="index">
            ...
            <div
              ...
              v-show="item.answerList && item.answerList.length > 0"
            >
              <div
                class="question_item answer"
                v-for="(items, index) of item.answerList"
                :key="index"
              >
                <div class="clearfix">
                  <span class="name"
    ...
    <div class="chat_input">
      <div class="chat_input_box">
        ...
        <textarea
          ...
          v-on:keypress="keyDown"
          :placeholder="
            isVisitorLogin || isForbit ? '' : $t('question.placehoad')
          "
        ></textarea>
      </div>
      <div class="clearfix">
