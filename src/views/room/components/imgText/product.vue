  ...
  <div class="product_wrap">
    ...
    >
      ...
      <div class="product_list">
        <div
          class="product_item"
          v-for="(item2, index2) of item.productlist"
          :key="index2"
        >
          <div class="product-img-box">
            <img
              :src="item2.imageUrl"
              alt=""
              @click="showDetailFn(item, item2)"
            />
            <div
              class="free-apply-btn"
              v-if="item2.price == '0'"
    ...
    <productDetial
      ...
      :title="detailTitle"
      @hideDetial="hideDetailFn"
      @applyFn="applyFn"
      @leaveMsgFn="leaveMsgFn"
    ></productDetial>
